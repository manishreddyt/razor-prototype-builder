      ...
      <div>
        ...
        <div className="flex gap-5 flex-wrap">
          {[
            ...
            { icon: "🏢", title: "Business settings", bg: "bg-yellow-100", links: ["GST details", { label: "Receipts settings", action: () => navigate("/account-settings/receipts") }, "Business details", "Bank account"] },
